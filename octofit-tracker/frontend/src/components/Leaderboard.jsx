...
function Leaderboard() {
  ...
  useEffect(() => { fetchCollection('leaderboard', leaderboardEndpoint).then(setRows).then(() => setStatus('ready')).catch((requestError) => { setError(requestError.message); setStatus('error') }) }, [])
